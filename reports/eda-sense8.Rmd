...
## Passo 2
## a. A média geral da avaaliação dos usuários de 'Xena a Princesa Guerreira' é maior que a de 'Thundercats', uma diferença bastantes pequena, porém, ao observarmos mais abaixo o gráfico das médias por temporadas percebemos que 'Thundercats' teve uma evlução continua durante suas temporadas, diferentemente de 'Xena' que teve uma queda da terceira para quarta temporada e logo em seguida voltou a subir na quinta e sexta temporadas.
...
episodes %>% 
    ...
    geom_line() + facet_wrap(~ series_name)
